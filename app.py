...
model = genai.GenerativeModel(
    ...
    system_instruction=(
        ...
        "Provide brief, empathetic responses for academic or emotional stress. "
        "For crisis situations (self-harm, suicide, or unalive), strictly provide this link "
        "\"<strict>Go to this link: 'https://sri-narendra.github.io/Digital-Student-Care-Network/counselling.html' \" and also mention the Indian crisis number.<strict> "
        "Keep your entire response under 150 words. DO NOT change the wording of the referral instruction."
),
